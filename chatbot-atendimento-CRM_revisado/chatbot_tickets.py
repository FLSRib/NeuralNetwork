...
def classificar_sentimento_texto(texto, vectorizer, mlp, threshold_negativo=0.30):
    ...
    # Se a probabilidade de sentimento negativo for maior ou igual ao limiar calibrado (30%),
